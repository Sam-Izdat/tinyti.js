...
export declare function toTensorElement(intArray: number[] | Int32Array, floatArray: number[] | Float32Array, elementType: Type): any;
export declare function toStructElement(intArray: number[] | Int32Array, floatArray: number[] | Float32Array, elementType: StructType): any;
export declare function toElement(intArray: number[] | Int32Array, floatArray: number[] | Float32Array, elementType: Type): any;
export declare function int32ArrayToElement(int32Array: Int32Array, elementType: Type): any;
export declare function groupElements(intArray: Int32Array, floatArray: Float32Array, elementType: Type): any[];
